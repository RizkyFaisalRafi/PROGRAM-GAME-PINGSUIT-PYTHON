...
print("Gunting\tvs\tBatu\t=\tBatu Win")
print("Kertas\tvs\tGunting\t=\tGunting Win")
print("Batu\tvs\tKertas\t=\tKertas Win")
...
while(True):
    ...
    player = input("Masukan pilihan (batu, guntung, kertas)")
    temp_list = ["batu", "gunting", "kertas"]
